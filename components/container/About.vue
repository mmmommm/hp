          ...
          <div class='flex mx-2 link-wrapper mt-8 ml-12 md:ml-48 md:w-full'>
            ...
            <div class='sm:w-1/3 lg:w-1/6'>
              <a href='https://twitter.com/kissessenose' target='_blank' rel='noopener'>
                <button class='py-2 px-4 rounded hover:opacity-75' aria-label='twitter link'>
            ...
            <div class='sm:w-1/3 lg:w-1/6 ml-4 md:ml-0 mt-2'>
              <nuxt-link to='/aboutDetail'>
                <button class='duration-500 ease-in-out bg-transparent text-black-700 font-semibold hover:bg-pink-200 py-2 px-4 border border-black-500 rounded' aria-label='about link'>
                  more ＞
                </button>
              </nuxt-link>
            </div>
